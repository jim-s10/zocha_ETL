...
-- TODO: Write a sqlalchemy for updating these fields:
-- member_id,
-- email_failure_count,
-- email_blocked,
-- phone_blocked,
...
final_user_attributes AS (
    SELECT
        ...
        , CAST(scu.age AS INTEGER) AS age --年齡
        ...
        , CAST(scu.birthday::DATE AS DATE) AS birthday --生日
        , CAST(scu.month_of_birthday AS INTEGER) AS birthday_month --月份壽星
        , CAST(scu."registerDate"::DATE AS DATE) AS join_datetime --會員加入日期
        ...
        , CAST(prev.notes AS VARCHAR(100)) AS notes
